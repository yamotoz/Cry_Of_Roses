...
echo "█─██─██▀▄█▀██─███─█▄▀─████─███";
echo "▀▄▄▄▄▀▄▄▄▄▄▀▄▄▄▀▄▄▄▀▀▄▄▀▀▄▄▄▀▀";
git clone https://github.com/KasRoudra/PyPhisher && git clone https://github.com/jaykali/maskphish && git clone https://github.com/thewhiteh4t/seeker && git clone  https://github.com/Lucksi/Mr.Holmes && git clone https://github.com/exiftool/exiftool && git clone https://github.com/techchipnet/CamPhish;
sleep 2;
echo "█▀▀ █ █▄░█ █ █▀ █░█";
echo "█▀░ █ █░▀█ █ ▄█ █▀█";
sleep 2;
